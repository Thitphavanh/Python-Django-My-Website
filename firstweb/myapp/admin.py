...
class CartAdmin(admin.ModelAdmin):
	list_display = ['id','user','productid','productname','price','quantity','total','stamp']
	
admin.site.register(Cart, CartAdmin)

class OrderListAdmin(admin.ModelAdmin):
	list_display = ['id','orderid','productid','productname','price','quantity','total']

admin.site.register(OrderList, OrderListAdmin)

class OrderPendingtAdmin(admin.ModelAdmin):
	list_display = ['id','user','name','tel','address','shipping','payment','stamp','paid','slip','sliptime','paymentid']
