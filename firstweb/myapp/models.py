...
class Catagory(models.Model):
	catagoryname = models.CharField(max_length=200, default='ສິນຄ້າທົ່ວໄປ')
...
class Allproduct(models.Model):
	catagoryname = models.ForeignKey(Catagory, on_delete=models.CASCADE, null=True, blank=True)
...
class OrderPending(models.Model):
	...
	payment = models.CharField(max_length=100)  # alibaba # QR code
